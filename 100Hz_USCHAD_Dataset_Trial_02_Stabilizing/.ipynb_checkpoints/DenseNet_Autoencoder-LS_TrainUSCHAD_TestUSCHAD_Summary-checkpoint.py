...
save_models_var = 'DenseNet-Autoencoder-Latent-Representations_TrainUSCHAD_TestUSCHAD'  
...
if os.path.exists(code_path+'/Unsupervised_Learning_LS_Summary_Window-'+str(window_size)+'.pckl'):
    f = open(code_path+'/Unsupervised_Learning_LS_Summary_Window-'+str(window_size)+'.pckl','rb')
    temp = pickle.load(f)
    f.close()
...
for free_liv_train_size_index in amount_of_data_indices:
    ...
    for seed_value_index in seed_indices:
        ...
        for trial_index in trial_indices:
            ...
            f = open(code_path+'/Unsupervised_Learning_LS_Summary_Window-'+str(window_size)+'.pckl','wb')
