...
save_models_var = 'DenseNet-Autoencoder-Transfer-Learning-TS-LS-Fine-Tune_Source-Lab_Target-USCHAD_Split-Case-' + str(sample_cases_split)

####################################
## Autoencoder model
ae_model_path = code_path + '/DenseNet-Autoencoder_TrainRandom_TestRandom_Split-Case-' + str(sample_cases_split) + '_WindowSize-' + str(window_size) + '/TrainSize-90_TestSize-10/AutoEncoder-Model-600-epochs.h5'
