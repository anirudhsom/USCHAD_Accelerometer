...
save_models_var = 'DenseNet-Transfer-Learning-Fine-Tune_Source-Lab_Target-USCHAD_Split-Case-' + str(sample_cases_split)
    ...
    for seed_value in seed_value_set:
        ...
        for trial in trial_value_set:
            if not os.path.exists(classifier_models_path + '/Seed-'+str(seed_value) + '/Trial-' + str(trial) + '_History.pckl'):
                ...
                history1 = classifier_model.fit(x_train,y_train,batch_size=4,epochs=50,verbose=2,validation_data=(x_test,y_test))
